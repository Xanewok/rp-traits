...
func main() {
	...
	fmt.Printf("%d\n", src.Intn(7849)+1) // fighterHairs
	fmt.Printf("%d\n", src.Intn(1000)+1) // fighterHairColors / 25
	fmt.Printf("%d\n", src.Intn(290)+1)  // fighterBacks
	// fmt.Printf("%d\n", src.Intn(273)+1)   // fighterBacks (Archers/Slayers)
	fmt.Printf("%d\n", src.Intn(10000)+1) // fighterAuras / 25
	fmt.Printf("%d\n", src.Intn(10400)+1) // fighterTops / 25
	fmt.Printf("%d\n", src.Intn(100)+1)   // fighterBottoms

	// # Clashes
	// Archer/Slayer => ! Green Cape && !Danger Coat && !Black Tassels
	// # Forces
	// Farmer Apron top => Farmer Apron bottom
	// Thrifty Getup top => Thrifty Getup bottom
	// Some tops => None bottom
